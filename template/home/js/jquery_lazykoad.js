function swl_lazyLoadExtend(a, b, c, d) {
	var e = a(b);
	a.fn.lazyload = function(c) {
		...
		delete c.effectspeed), a.extend(h, c)), g = h.container === d || h.container === b ? e : a(h.container), 0 === h.event.indexOf("scroll") && g.bind(h.event, function() {
			return i()
		}), this.each(function() {
			var b = this, c = a(b);
...
function swl_lazyLoadInit() {
	return "undefined" == typeof SWL ? (window.setTimeout(function() {
		swl_lazyLoadInit()
	}, 50),
	void 0) : (swl_lazyLoadExtend(SWL.jQuery, window, document),
	void 0)
}swl_lazyLoadInit(); 