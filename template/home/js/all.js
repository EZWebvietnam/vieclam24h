try {
	window.FB || (function(window) {
		...
		var ES5 = function() {
			...
			__d("ES5Object", [], function(a, b, c, d, e, f) {
				...
				g.keys = function(h) {
					...
					var l = !( {
						toString : true
					}).propertyIsEnumerable('toString'), m = ['toString', 'toLocaleString', 'valueOf', 'hasOwnProperty', 'isPrototypeOf', 'prototypeIsEnumerable', 'constructor'];
					if (l)
			...
			__d("ES5", ["ES5ArrayPrototype", "ES5FunctionPrototype", "ES5StringPrototype", "ES5Array", "ES5Object", "ES5Date", "JSON3"], function(a, b, c, d, e, f) {
				var g = b('ES5ArrayPrototype'), h = b('ES5FunctionPrototype'), i = b('ES5StringPrototype'), j = b('ES5Array'), k = b('ES5Object'), l = b('ES5Date'), m = b('JSON3'), n = Array.prototype.slice, o = Object.prototype.toString, p = {
		...
		__d("sdk.Model", ["Type", "ObservableMixin"], function(a, b, c, d, e, f) {
			var g = b('Type'), h = b('ObservableMixin'), i = g.extend({
		...
		__d("sdk.Runtime", ["sdk.Model", "copyProperties", "sdk.RuntimeConfig"], function(a, b, c, d, e, f) {
			var g = b('sdk.Model'), h = c('sdk.RuntimeConfig'), i = b('copyProperties'), j = {
				UNKNOWN : 0,
				PAGETAB : 1,
				CANVAS : 2,
				PLATFORM : 4
		...
		__d("sdk.createIframe", ["copyProperties", "guid", "hasNamePropertyBug", "DOMEventListener"], function(a, b, c, d, e, f) {
			...
			function k(l) {
				l = g({}, l);
				var m, n = l.name || h(), o = l.root, p = l.style || {
					border : 'none'
				}, q = l.url, r = l.onload;
				if (i()) {
		...
		__d("UserAgent", [], function(a, b, c, d, e, f) {
			...
			function v() {
				if (g)
					return;
				g = true;
				var x = navigator.userAgent, y = /(?:MSIE.(\d+\.\d+))|(?:(?:Firefox|GranParadiso|Iceweasel).(\d+\.\d+))|(?:Opera(?:.+Version.|.)(\d+\.\d+))|(?:AppleWebKit.(\d+(?:\.\d+)?))|(?:Trident\/\d+\.\d+.*rv:(\d+\.\d+))/.exec(x), z = /(Mac OS X)|(Windows)|(Linux)/.exec(x);
		...
		__d("sdk.Content", ["sdk.domReady", "Log", "UserAgent"], function(a, b, c, d, e, f) {
			var g = b('sdk.domReady'), h = b('Log'), i = b('UserAgent'), j, k, l = {
				append : function(m, n) {
					if (!n)
						if (!j) {
			...
			g(i.prototype, {
				stub : function(j) {
					this.remote[j] = ES5(function() {
						var k = Array.prototype.slice.call(arguments), l = {
							jsonrpc : '2.0',
							method : j
						};
		...
		__d("GlobalCallback", ["DOMWrapper", "dotAccess", "guid", "wrapFunction"], function(a, b, c, d, e, f) {
			var g = b('DOMWrapper'), h = b('dotAccess'), i = b('guid'), j = b('wrapFunction'), k, l, m = {
		...
		__d("XDM", ["DOMEventListener", "DOMWrapper", "emptyFunction", "Flash", "GlobalCallback", "guid", "Log", "UserAgent", "wrapFunction"], function(a, b, c, d, e, f) {
			var g = b('DOMEventListener'), h = b('DOMWrapper'), i = b('emptyFunction'), j = b('Flash'), k = b('GlobalCallback'), l = b('guid'), m = b('Log'), n = b('UserAgent'), o = b('wrapFunction'), p = {}, q = {
				transports : []
			}, r = h.getWindow();
			function s(u) {
		...
		__d("sdk.XD", ["sdk.Content", "sdk.createIframe", "sdk.feature", "sdk.Event", "guid", "Log", "QueryString", "Queue", "resolveURI", "resolveWindow", "sdk.RPC", "sdk.Runtime", "UrlMap", "URL", "wrapFunction", "XDM", "XDConfig"], function(a, b, c, d, e, f) {
			var g = b('sdk.Content'), h = b('sdk.createIframe'), i = b('sdk.feature'), j = b('sdk.Event'), k = b('guid'), l = b('Log'), m = b('QueryString'), n = b('Queue'), o = b('resolveURI'), p = b('resolveWindow'), q = b('sdk.RPC'), r = b('sdk.Runtime'), s = b('UrlMap'), t = b('URL'), u = b('wrapFunction'), v = c('XDConfig'), w = b('XDM'), x = new n(), y = new n(), z = new n(), aa, ba, ca = k(), da = k(), ea = location.protocol + '//' + location.host, fa, ga = false, ha = 'Facebook Cross Domain Communication Frame', ia = {}, ja = new n();
			q.setInQueue(ja);
			function ka(qa) {
			...
			function ma(qa, ra) {
				if (ra && ra !== 'native' && !t(ra).isFacebookURL())
					return;
				if ( typeof qa == 'string') {
					if (/^FB_RPC:/.test(qa)) {
				...
				if (qa.access_token)
					r.setSecure(/^https/.test(ea));
				if (qa.cb) {
					var ta = pa._callbacks[qa.cb];
					if (!pa._forever[qa.cb])
						delete pa._callbacks[qa.cb];
					if (ta)
						ta(qa);
				}
			}
			...
			function oa(qa, ra) {
				...
				var ta = g.appendHidden(document.createElement('div')), ua = i('kill_fragment') ? ['fragment'] : null, va = w.create({
					blacklist : ua,
					root : ta,
					channel : da,
					channelPath : '/' + v.XdUrl + '#',
					...
					whenReady : function(wa) {
						...
						var xa = {
							...
							transport : va,
							xd_name : ra
						}, ya = '/' + v.XdUrl + '#' + m.encode(xa), za = v.useCdn ? s.resolve('cdn', false) : 'http://www.facebook.com', ab = v.useCdn ? s.resolve('cdn', true) : 'https://www.facebook.com';
						if (r.getSecure() !== true)
							aa = h({
								url : za + ya,
				...
				if (va === 'fragment')
					window.FB_XD_onMessage = u(ma, 'entry', 'XD:fragment');
				ga = true;
			}
			...
			(function() {
				...
				if (qa) {
					...
					var ra = m.decode(qa[1]), sa = p(ra.xd_rel);
		...
		__d("sdk.Auth", ["sdk.Cookie", "copyProperties", "sdk.createIframe", "DOMWrapper", "sdk.feature", "sdk.getContextType", "guid", "sdk.Impressions", "Log", "ObservableMixin", "QueryString", "sdk.Runtime", "sdk.SignedRequest", "UrlMap", "URL", "sdk.XD"], function(a, b, c, d, e, f) {
			var g = b('sdk.Cookie'), h = b('copyProperties'), i = b('sdk.createIframe'), j = b('DOMWrapper'), k = b('sdk.feature'), l = b('sdk.getContextType'), m = b('guid'), n = b('sdk.Impressions'), o = b('Log'), p = b('ObservableMixin'), q = b('QueryString'), r = b('sdk.Runtime'), s = b('sdk.SignedRequest'), t = b('UrlMap'), u = b('URL'), v = b('sdk.XD'), w, x, y = new p();
			function z(fa, ga) {
				var ha = r.getUserID(), ia = '';
				if (fa)
					if (fa.userID) {
						ia = fa.userID;
				...
				var ka = r.getLoginStatus(), la = (ka === 'unknown' && fa) || (r.getUseCookie() && r.getCookieUserID() !== ia), ma = ha && !fa, na = fa && ha && ha != ia, oa = fa != w, pa = ga != (ka || 'unknown');
				r.setLoginStatus(ga);
				...
				return function(ia) {
					...
					if (ia && ia.access_token) {
						...
						if (ia.granted_scopes)
							ga.grantedScopes = ia.granted_scopes;
						if (r.getUseCookie()) {
							var la = ga.expiresIn === 0 ? 0 : ES5('Date', 'now', false) + ga.expiresIn * 1000, ma = g.getDomain();
			...
			function ca(fa) {
				...
				var ia = ba(fa, w, 'login_status'), ja = u(t.resolve('www', true) + '/connect/ping').setSearch(q.encode({
		...
		__d("ApiClient", ["ArgumentError", "Assert", "copyProperties", "CORSRequest", "FlashRequest", "flattenObject", "JSONPRequest", "Log", "ObservableMixin", "sprintf", "UrlMap", "URL", "ApiClientConfig"], function(a, b, c, d, e, f) {
			var g = b('ArgumentError'), h = b('Assert'), i = b('copyProperties'), j = b('CORSRequest'), k = b('FlashRequest'), l = b('flattenObject'), m = b('JSONPRequest'), n = b('Log'), o = b('ObservableMixin'), p = b('sprintf'), q = b('UrlMap'), r = b('URL'), s = b('ApiClientConfig'), t, u, v, w = {
				get : true,
				post : true,
				'delete' : true,
				put : true
			...
			function aa(da) {
				...
				var ha = (fa.string || 'get').toLowerCase(), ia = i(fa.object || {}, ea.getParsedSearch()), ja = fa['function'];
				if (!ja)
			...
			function ba(da, ea) {
				...
				da.api_key = u;
				var ga = fa in x ? 'api_read' : 'api', ha = q.resolve(ga) + '/restserver.php', ia = ES5(z, 'bind', true, null, ea, '/restserver.php', 'get', da);
				y(ha, 'get', da, ia);
			}
		...
		__d("sdk.Dialog", ["sdk.Canvas.Environment", "sdk.Content", "sdk.DOM", "DOMEventListener", "sdk.Intl", "ObservableMixin", "sdk.Runtime", "Type", "UserAgent"], function(a, b, c, d, e, f) {
			var g = b('sdk.Canvas.Environment'), h = b('sdk.Content'), i = b('sdk.DOM'), j = b('DOMEventListener'), k = b('sdk.Intl'), l = b('ObservableMixin'), m = b('sdk.Runtime'), n = b('Type'), o = b('UserAgent'), p = n.extend({
		...
		__d("sdk.Frictionless", ["sdk.Auth", "sdk.api", "sdk.Event", "sdk.Dialog"], function(a, b, c, d, e, f) {
			var g = b('sdk.Auth'), h = b('sdk.api'), i = b('sdk.Event'), j = b('sdk.Dialog'), k = {
				_allowedRecipients : {},
		...
		__d("sdk.Native", ["copyProperties", "Log", "UserAgent"], function(a, b, c, d, e, f) {
			var g = b('copyProperties'), h = b('Log'), i = b('UserAgent'), j = 'fbNativeReady', k = {
				onready : function(l) {
					if (!i.nativeApp()) {
		...
		__d("sdk.UIServer", ["sdk.Auth", "sdk.Content", "copyProperties", "sdk.Dialog", "sdk.DOM", "sdk.Event", "flattenObject", "sdk.Frictionless", "sdk.getContextType", "guid", "insertIframe", "Log", "sdk.Native", "QueryString", "resolveURI", "sdk.RPC", "sdk.Runtime", "UrlMap", "UserAgent", "sdk.XD", "SDKConfig"], function(a, b, c, d, e, f) {
			var g = b('sdk.Auth'), h = b('sdk.Content'), i = b('copyProperties'), j = b('sdk.Dialog'), k = b('sdk.DOM'), l = b('sdk.Event'), m = b('flattenObject'), n = b('sdk.Frictionless'), o = b('sdk.getContextType'), p = b('guid'), q = b('insertIframe'), r = b('Log'), s = b('sdk.Native'), t = b('QueryString'), u = b('resolveURI'), v = b('sdk.RPC'), w = b('sdk.Runtime'), x = c('SDKConfig'), y = b('UrlMap'), z = b('UserAgent'), aa = b('sdk.XD'), ba = {
		...
		__d("sdk.Canvas.Plugin", ["sdk.api", "sdk.RPC", "Log", "sdk.Runtime", "createArrayFrom"], function(a, b, c, d, e, f) {
			var g = b('sdk.api'), h = b('sdk.RPC'), i = b('Log'), j = b('sdk.Runtime'), k = b('createArrayFrom'), l = 'CLSID:D27CDB6E-AE6D-11CF-96B8-444553540000', m = 'CLSID:444785F1-DE89-4295-863A-D46C3A781394', n = null;
			function o(y) {
		...
		__d("legacy:fb.canvas", ["Assert", "sdk.Canvas.Environment", "sdk.Event", "FB", "sdk.Canvas.Plugin", "sdk.Canvas.IframeHandling", "Log", "sdk.Canvas.Navigation", "sdk.Runtime", "sdk.Canvas.Tti"], function(a, b, c, d) {
			var e = b('Assert'), f = b('sdk.Canvas.Environment'), g = b('sdk.Event'), h = b('FB'), i = b('sdk.Canvas.Plugin'), j = b('sdk.Canvas.IframeHandling'), k = b('Log'), l = b('sdk.Canvas.Navigation'), m = b('sdk.Runtime'), n = b('sdk.Canvas.Tti');
			h.provide('Canvas', {
				setSize : function(o) {
		...
		__d("sdk.Canvas.Prefetcher", ["sdk.api", "createArrayFrom", "sdk.Runtime", "CanvasPrefetcherConfig"], function(a, b, c, d, e, f) {
			var g = b('sdk.api'), h = b('createArrayFrom'), i = c('CanvasPrefetcherConfig'), j = b('sdk.Runtime'), k = {
				AUTOMATIC : 0,
				MANUAL : 1
		...
		__d("sdk.Data", ["sdk.api", "sdk.ErrorHandling", "mergeArrays", "sdk.Query", "safeEval", "sdk.Waitable"], function(a, b, c, d, e, f) {
			var g = b('sdk.api'), h = b('sdk.ErrorHandling'), i = b('mergeArrays'), j = b('sdk.Query'), k = b('safeEval'), l = b('sdk.Waitable'), m = {
				query : function(n, o) {
		...
		__d("legacy:fb.pay", ["FB", "copyProperties", "sdk.Runtime", "sdk.UIServer", "sdk.XD"], function(a, b, c, d) {
			b('FB');
			var e = b('copyProperties'), f = b('sdk.Runtime'), g = b('sdk.UIServer'), h = b('sdk.XD'), i = {
				error_code : 1383001,
		...
		__d("IframePlugin", ["sdk.Auth", "sdk.createIframe", "copyProperties", "sdk.DOM", "sdk.Event", "guid", "Log", "ObservableMixin", "PluginPipe", "QueryString", "resolveURI", "sdk.Runtime", "Type", "UrlMap", "UserAgent", "sdk.XD"], function(a, b, c, d, e, f) {
			var g = b('sdk.Auth'), h = b('sdk.createIframe'), i = b('copyProperties'), j = b('sdk.DOM'), k = b('sdk.Event'), l = b('guid'), m = b('Log'), n = b('ObservableMixin'), o = b('PluginPipe'), p = b('QueryString'), q = b('resolveURI'), r = b('sdk.Runtime'), s = b('Type'), t = b('UrlMap'), u = b('UserAgent'), v = b('sdk.XD'), w = {
				skin : 'string',
				font : 'string',
				width : 'px',
				height : 'px',
			...
			var da = s.extend({
				constructor : function(ea, fa, ga, ha) {
					...
					var ja = r.getSecure() || window.location.protocol == 'https:', ka = t.resolve('www', ja) + '/plugins/' + ga + '.php?', la = {};
		...
		__d("sdk.XFBML.Element", ["sdk.DOM", "Type", "ObservableMixin"], function(a, b, c, d, e, f) {
			var g = b('sdk.DOM'), h = b('Type'), i = b('ObservableMixin'), j = h.extend({
		...
		__d("sdk.XFBML.IframeWidget", ["sdk.Arbiter", "sdk.Auth", "sdk.Content", "copyProperties", "sdk.DOM", "sdk.Event", "sdk.XFBML.Element", "guid", "insertIframe", "QueryString", "sdk.Runtime", "sdk.ui", "UrlMap", "sdk.XD"], function(a, b, c, d, e, f) {
			var g = b('sdk.Arbiter'), h = b('sdk.Auth'), i = b('sdk.Content'), j = b('copyProperties'), k = b('sdk.DOM'), l = b('sdk.Event'), m = b('sdk.XFBML.Element'), n = b('guid'), o = b('insertIframe'), p = b('QueryString'), q = b('sdk.Runtime'), r = b('sdk.ui'), s = b('UrlMap'), t = b('sdk.XD'), u = m.extend({
				_iframeName : null,
				_showLoader : true,
		...
		__d("sdk.XFBML.Comments", ["sdk.Event", "sdk.XFBML.IframeWidget", "QueryString", "sdk.Runtime", "UrlMap", "UserAgent", "SDKConfig"], function(a, b, c, d, e, f) {
			var g = b('sdk.Event'), h = b('sdk.XFBML.IframeWidget'), i = b('QueryString'), j = b('sdk.Runtime'), k = c('SDKConfig'), l = b('UrlMap'), m = b('UserAgent'), n = h.extend({
		...
		__d("sdk.XFBML.CommentsCount", ["sdk.Data", "sdk.DOM", "sdk.XFBML.Element", "sprintf"], function(a, b, c, d, e, f) {
			var g = b('sdk.Data'), h = b('sdk.DOM'), i = b('sdk.XFBML.Element'), j = b('sprintf'), k = i.extend({
				process : function() {
		...
		__d("sdk.Helper", ["sdk.ErrorHandling", "sdk.Event", "safeEval", "UrlMap"], function(a, b, c, d, e, f) {
			var g = b('sdk.ErrorHandling'), h = b('sdk.Event'), i = b('safeEval'), j = b('UrlMap'), k = {
				isUser : function(l) {
		...
		__d("sdk.XFBML.ConnectBar", ["sdk.Anim", "sdk.api", "sdk.Auth", "createArrayFrom", "sdk.Data", "sdk.DOM", "sdk.XFBML.Element", "escapeHTML", "sdk.Event", "format", "sdk.Helper", "sdk.Insights", "sdk.Intl", "sdk.Runtime", "UrlMap", "UserAgent", "ConnectBarConfig"], function(a, b, c, d, e, f) {
			var g = b('sdk.Anim'), h = b('sdk.api'), i = b('sdk.Auth'), j = b('createArrayFrom'), k = c('ConnectBarConfig'), l = b('sdk.Data'), m = b('sdk.DOM'), n = b('sdk.XFBML.Element'), o = b('escapeHTML'), p = b('sdk.Event'), q = b('format'), r = b('sdk.Helper'), s = b('sdk.Insights'), t = b('sdk.Intl'), u = b('sdk.Runtime'), v = b('UrlMap'), w = b('UserAgent'), x = n.extend({
				_initialHeight : null,
				_initTopMargin : 0,
		...
		__d("sdk.XFBML.EdgeCommentWidget", ["sdk.XFBML.IframeWidget", "sdk.DOM"], function(a, b, c, d, e, f) {
			var g = b('sdk.XFBML.IframeWidget'), h = b('sdk.DOM'), i = 10000, j = g.extend({
				constructor : function(k) {
		...
		__d("sdk.XFBML.EdgeWidget", ["sdk.Event", "sdk.XFBML.IframeWidget", "sdk.XFBML.EdgeCommentWidget", "sdk.DOM", "sdk.Helper", "sdk.Runtime"], function(a, b, c, d, e, f) {
			var g = b('sdk.Event'), h = b('sdk.XFBML.IframeWidget'), i = b('sdk.XFBML.EdgeCommentWidget'), j = b('sdk.DOM'), k = b('sdk.Helper'), l = b('sdk.Runtime'), m = h.extend({
				_visibleAfter : 'immediate',
				_showLoader : false,
				_rootPadding : null,
				setupAndValidate : function() {
				...
				_getWidgetHeight : function() {
					var n = this._getLayout(), o = this._shouldShowFaces() ? 'show' : 'hide', p = this._getBoolAttribute('send') || this._getBoolAttribute('share'), q = 65 + ( p ? 25 : 0), r = {
						standard : {
							show : 80,
							hide : 35
						},
				...
				_getWidgetWidth : function() {
					var n = this._getLayout(), o = this._getBoolAttribute('send') || this._getBoolAttribute('share'), p = this._shouldShowFaces() ? 'show' : 'hide', q = (this.getAttribute('action') === 'recommend'), r = ( q ? 265 : 225) + ( o ? 60 : 0), s = ( q ? 130 : 90) + ( o ? 60 : 0), t = this.getAttribute('action') === 'recommend' ? 100 : 55, u = this.getAttribute('action') === 'recommend' ? 90 : 50, v = {
						standard : {
							show : 450,
							hide : 450
						},
					...
					}, w = v[n][p], x = this._getPxAttribute('width', w), y = {
						standard : {
							min : r,
							max : 900
						},
				...
				_getWidthOffset : function(n) {
					var o = parseFloat(n['anchorPosition[x]']) + this._rootPadding.left, p = j.getPosition(this.dom).x, q = this.dom.offsetWidth, r = j.getViewportInfo().width, s = parseFloat(n.width), t = false;
					if (l.getRtl()) {
						t = s < p;
					} else if ((p + s) > r)
						t = true;
		...
		__d("sdk.XFBML.SendButtonFormWidget", ["sdk.XFBML.EdgeCommentWidget", "sdk.DOM", "sdk.Event"], function(a, b, c, d, e, f) {
			var g = b('sdk.XFBML.EdgeCommentWidget'), h = b('sdk.DOM'), i = b('sdk.Event'), j = g.extend({
				constructor : function(k) {
					this.parent(k);
		...
		__d("sdk.XFBML.Like", ["sdk.XFBML.EdgeWidget", "sdk.XFBML.SendButtonFormWidget"], function(a, b, c, d, e, f) {
			var g = b('sdk.XFBML.EdgeWidget'), h = b('sdk.XFBML.SendButtonFormWidget'), i = g.extend({
				getUrlBits : function() {
					return {
						name : 'like',
						params : this._attr
		...
		__d("sdk.XFBML.LiveStream", ["sdk.XFBML.IframeWidget"], function(a, b, c, d, e, f) {
			var g = b('sdk.XFBML.IframeWidget'), h = g.extend({
				_visibleAfter : 'load',
				setupAndValidate : function() {
					this._attr = {
		...
		__d("sdk.XFBML.LoginButton", ["sdk.Helper", "IframePlugin"], function(a, b, c, d, e, f) {
			var g = b('sdk.Helper'), h = b('IframePlugin'), i = h.extend({
		...
		__d("sdk.XFBML.Name", ["copyProperties", "sdk.Data", "escapeHTML", "sdk.Event", "sdk.XFBML.Element", "sdk.Helper", "Log", "sdk.Runtime"], function(a, b, c, d, e, f) {
			var g = b('copyProperties'), h = b('sdk.Data'), i = b('escapeHTML'), j = b('sdk.Event'), k = b('sdk.XFBML.Element'), l = b('sdk.Helper'), m = b('Log'), n = b('sdk.Runtime'), o = k.extend({
				process : function() {
					g(this, {
		...
		__d("sdk.XFBML.RecommendationsBar", ["sdk.Arbiter", "DOMEventListener", "sdk.Event", "sdk.XFBML.IframeWidget", "resolveURI", "sdk.Runtime"], function(a, b, c, d, e, f) {
			var g = b('sdk.Arbiter'), h = b('DOMEventListener'), i = b('sdk.Event'), j = b('sdk.XFBML.IframeWidget'), k = b('resolveURI'), l = b('sdk.Runtime'), m = j.extend({
				getUrlBits : function() {
					return {
		...
		__d("sdk.XFBML.Registration", ["sdk.Auth", "sdk.Helper", "sdk.XFBML.IframeWidget", "sdk.Runtime", "UrlMap"], function(a, b, c, d, e, f) {
			var g = b('sdk.Auth'), h = b('sdk.Helper'), i = b('sdk.XFBML.IframeWidget'), j = b('sdk.Runtime'), k = b('UrlMap'), l = i.extend({
				_visibleAfter : 'immediate',
				_baseHeight : 167,
				_fieldHeight : 28,
				_skinnyWidth : 520,
		...
		__d("sdk.XFBML.SocialContext", ["sdk.Event", "sdk.XFBML.IframeWidget"], function(a, b, c, d, e, f) {
			var g = b('sdk.Event'), h = b('sdk.XFBML.IframeWidget'), i = h.extend({
				setupAndValidate : function() {
		...
		__d("legacy:fb.xfbml", ["Assert", "sdk.domReady", "sdk.Event", "FB", "IframePlugin", "PluginTags", "wrapFunction", "XFBML", "sdk.XFBML.Comments", "sdk.XFBML.CommentsCount", "sdk.XFBML.ConnectBar", "sdk.XFBML.Like", "sdk.XFBML.LiveStream", "sdk.XFBML.LoginButton", "sdk.XFBML.Name", "sdk.XFBML.RecommendationsBar", "sdk.XFBML.Registration", "sdk.XFBML.SocialContext"], function(a, b, c, d) {
			var e = b('Assert'), f = b('sdk.domReady'), g = b('sdk.Event'), h = b('FB'), i = b('IframePlugin'), j = b('PluginTags'), k = b('wrapFunction'), l = b('XFBML'), m = {
