...
<html lang="en">
	<head>
		<meta charset="utf-8" />
		<title>ADMINISTRATOR - HUTECH DEVELOPERS CLUB</title>
						...
						<div class="login-container">
							<div class="row-fluid">
								<div class="center">
									...
									<h4 class="blue">&copy; HUTECH DEVELOPERS CLUB</h4>
								</div>
							</div>
...
<![endif]-->
		...
		<script type="text/javascript">
			if("ontouchend" in document) document.write("<script src='<?php echo base_url();?>template/admin/assets/js/jquery.mobile.custom.min.js'>"+"<"+"/script>");
		</script>
