...
class Daluu_post extends CI_Model
{
    ...
    {
        $id = intval($id);
        $sql_join =" SELECT tbl_job_post.e_id,tbl_job_post.u_id,tbl_job_post.e_title,tbl_job_post.m_id,tbl_job_post.e_daluu1,tbl_job_post.e_nghe,tbl_job_post.e_nghe1,tbl_job_post.e_daluu1,tbl_job_post.e_daungtuyen1,tbl_job_post.e_nghe2,tbl_job_post.e_nghe3,tbl_job_post.e_mem,tbl_job_post.e_cityID,tbl_job_post.e_cityID1,tbl_job_post.e_cityID2,tbl_job_post.e_cityID3,tbl_job_post.e_luong,tbl_job_post.e_luonga,tbl_job_post.e_luongb,tbl_job_post.e_date,tbl_job_post.e_dateActive,tbl_job_post.e_lastDate,tbl_job_post.e_visits,tbl_job_post.e_datesave"
